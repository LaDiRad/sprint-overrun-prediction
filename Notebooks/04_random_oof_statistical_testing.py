# -*- coding: utf-8 -*-
"""04_random_oof_statistical_testing.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ds-FQEn_Q5iyDVwanpeagbYuQJ1u4GtC
"""
...
IN2, IN3 = f'{PROJECT}/02_random_benchmark', f'{PROJECT}/03c_random_oof_threshold'
OUT = f'{PROJECT}/04_statistical_testing_oof'
...
# Calculate MCC per fold for top 2 optimized models and for the first
# model optimized vs. non-optimized
...
# Wilcoxon signed-rank test (uses mcc_final, mcc_runner, mcc_own_base
